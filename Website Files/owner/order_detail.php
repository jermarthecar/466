        ...
        <div style="display: flex; gap: 20px;">
            ...
            <div style="flex: 1; background: #f9f9f9; padding: 20px; border-radius: 5px;">
                ...
                <div style="text-align: right; margin-top: 20px;">
                    ...
                    <p><strong>Shipping:</strong> $<?php echo number_format($order['ShippingCost'], 2); ?></p>
                    <p><strong>Total:</strong> $<?php echo number_format($order['OrderTotal'] + $order['Tax'] + $order['ShippingCost'], 2); ?></p>
                </div>
            </div>
        </div>
